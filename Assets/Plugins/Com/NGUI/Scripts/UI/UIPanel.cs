...
public class UIPanel : UIRect
{
    ...
    public delegate void OnSortingOrderChange(int sortingOrder);
    ...
    public OnSortingOrderChange onSortingOrderChange;
...
#endif
				UpdateDrawCalls();
                if (onSortingOrderChange != null) onSortingOrderChange(value);
			}
		}
	}
