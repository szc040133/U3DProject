...
public class UISavedOption : MonoBehaviour
{
	...
	void OnEnable()
	{
		...
		{
			mCheck.onChange.AddListener(SaveState);
	...
	void OnDisable()
	{
		if (mCheck != null) mCheck.onChange.RemoveListener(SaveState);
	...
	public void SaveState(UIToggle toggle, bool state) { PlayerPrefs.SetInt(key, state ? 1 : 0); }
