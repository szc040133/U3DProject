...
{
    [Serializable]
    public class UIScrollViewEvent : UnityEvent { }
    [SerializeField]
    private readonly UIScrollViewEvent _onValueChange = new UIScrollViewEvent();
    public UIScrollViewEvent onValueChange { get { return _onValueChange; } }
