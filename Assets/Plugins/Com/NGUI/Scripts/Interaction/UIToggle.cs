...
public class UIToggle : UIWidgetContainer
{
	...
	[SerializeField]
	private readonly UIToggleEvent _onChange = new UIToggleEvent();
	...
	public bool value
	{
		...
		set
		{
			...
			else if (group == "" || value || optionCanBeNone || !mStarted) Set(value);
		}
	}
	...
	public static UIToggle GetActiveToggle(string group)
	{
	...
	public UIToggleEvent onChange { get { return _onChange; } }
}
