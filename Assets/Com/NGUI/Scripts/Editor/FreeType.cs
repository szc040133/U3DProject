...
public static class FreeType
{
	...
	public static string[] GetFaces (Font font)
	{
	...
	public static bool CreateFont (Font ttf, int size, int faceIndex, bool kerning, string characters, int padding, out BMFont font, out Texture2D tex)
	{
		font = null;
		tex = null;
