...
#region Attach
	...
	public static void Add10a () { AddIfMissing<UIKeyNavigation>(); }
...
#region Options
	...
	public static void TurnGizmosOn ()
	{
	...
	public static bool TurnGizmosOnCheck () { return !NGUISettings.showTransformHandles; }

	[MenuItem("NGUI/Options/Transform Move Gizmo/Turn Off", false, 10)]
	public static void TurnGizmosOff () { NGUISettings.showTransformHandles = false; }

	[MenuItem("NGUI/Options/Transform Move Gizmo/Turn Off", true, 10)]
	public static bool TurnGizmosOffCheck () { return NGUISettings.showTransformHandles; }
	...
	public static bool SetToMinCheck () { return !NGUISettings.minimalisticLook; }

	[MenuItem("NGUI/Options/Inspector Look/Set to Distinct", false, 10)]
	public static void SetToDistinct ()
	{
	...
	public static bool SetToDistinctCheck () { return NGUISettings.minimalisticLook; }

	[MenuItem("NGUI/Options/Inspector Look/Set to Unified", false, 10)]
	public static void SetToUnified ()
	{
	...
	public static bool SetToUnifiedCheck () { return !NGUISettings.unifiedTransform; }

	[MenuItem("NGUI/Options/Inspector Look/Set to Traditional", false, 10)]
	public static void SetToTraditional ()
	{
	...
	public static bool SetToTraditionalCheck () { return NGUISettings.unifiedTransform; }
	...
	public static void ResetPrefabTool ()
	{
	...
	public static bool AlignSVToUICheck ()
	{
	...
	public static void AlignSVWithSelectedUI () { AlignSVToUI(); }

	[MenuItem("GameObject/Align View To Selected UI &f", true, 999)]
	public static bool AlignSVWithSelectedUICheck ()
	{
		GameObject go = Selection.activeGameObject;
		if (go == null) return false;
