...
{
	public new static UIWidgetInspector instance;
	...
	public static void DrawColor (SerializedObject so, UIWidget w)
	{
	...
	public static void DrawInspectorProperties (SerializedObject so, UIWidget w, bool drawColor)
	{
		if (drawColor)
		{
			DrawColor(so, w);
