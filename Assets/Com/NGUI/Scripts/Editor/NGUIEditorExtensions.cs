...
public static class NGUIEditorExtensions
{
	...
	public static RenderTexture RenderToTexture (this Camera cam, int width, int height)
	{
	...
	public static bool SaveRenderTextureAsPNG (this Camera cam, string filename)
	{
		// Render textures only work in Unity Pro
